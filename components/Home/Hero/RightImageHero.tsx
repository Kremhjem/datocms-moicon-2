          ...
          <div className="flex flex-col items-start sm:text-center lg:py-12 lg:text-left xl:w-10/12 xl:py-24 ">
            ...
            <div className="flex w-full flex-row items-center justify-center gap-2.5 sm:justify-center lg:justify-start">
              {buttons.map((button) => {
                ...
                const secondary =
                  'inline-block rounded-lg bg-gray-200 px-8 py-3 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-h1subtitle focus-visible:ring active:text-gray-700 md:text-base';
                return (
                  <a
                    key={button.id}
                    href={button.url || '#'}
