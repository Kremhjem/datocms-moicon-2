...
export type DocumentationPageModelContentField = {
  ...
  blocks: Array<Scalars['String']['output']>;
  links: Array<DocumentationPageRecord>;
  value: Scalars['JsonField']['output'];
};
...
export type PostModelContentBlocksField = AppCtaRecord | CtaButtonWithImageRecord | ImageBlockRecord | NewsletterSubscriptionRecord | VideoSectionRecord;
...
export type PricingSectionRecord = RecordInterface & {
  ...
  pricingSectionCtatext?: Maybe<Scalars['String']['output']>;
...
/** Block of type 💰 Pricing section (pricing_section) */
export type PricingSectionRecordPricingSectionCtatextArgs = {
  markdown?: InputMaybe<Scalars['Boolean']['input']>;
};
