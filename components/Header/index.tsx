          ...
          <div className="relative flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-end px-4">
              <div>
                ...
                >
                  <span
                    className={`relative my-1.5 block h-0.5 w-[30px] bg-h1subtitle transition-all duration-300 dark:bg-white ${
                ...
                <nav
                  id="navbarCollapse"
                  className={`navbar absolute right-0 z-30 w-[250px] rounded border-[.5px] border-body-color/50 bg-menugray px-6 py-4 duration-300 dark:border-body-color/20 dark:bg-dark lg:visible lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 ${
                    navbarOpen
