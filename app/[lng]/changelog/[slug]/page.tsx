...
const ChangelogPage = async ({ params: { slug, lng } }: Params) => {
  ...
  return (
    <section className="py-32 text-gray-700">
      <div className=" mx-auto flex flex-col items-center px-5 lg:px-24">
        <div>
          <div className="flex flex-wrap md:flex-nowrap">
            <div className="mb-6 flex flex-shrink-0 flex-col px-4 md:mb-0 md:w-64">
              <strong className="flex text-left text-3xl font-thin leading-none lg:text-4xl">
                {data.changeLog.versionName} <span className="text-sm"> </span>
              </strong>
              <span className="mt-1 text-xs font-normal leading-relaxed text-h1subtitle">
              ...
              <StructuredText
                ...
                customNodeRules={[
                  renderNodeRule(isHeading, ({ children, key }) => {
                    return (
                      <h3
                        className="mb-2 mt-4 text-lg text-h1title leading-5"
                        key={key}
                      >
                        {children}
                      </h3>
                  ...
                  renderNodeRule(isParagraph, ({ children, key }) => {
                    return (
                      <div className="mb-4 text-sm text-h1subtitle" key={key}>
                        {children}
                      </div>
                    );
                  }),
