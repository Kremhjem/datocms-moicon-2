...
const DetailSection = ({ details, image, imagePosition }: Props) => {
  return (
    <section className="py-16 bg-graysplitbg px-6 md:py-20 lg:text-start">
      <div className="container">
        <div className="mx-auto max-w-6xl flex flex-col items-center justify-center lg:flex-row lg:flex-wrap ">
                ...
                <StructuredText
                  ...
                  customNodeRules={[
                    renderNodeRule(isHeading, ({ children, key }) => {
                      return (
                        <h3
                          className="mb-4 mt-9 lowercase text-xl font-light text-h1title dark:text-white sm:text-xl lg:text-xl xl:text-4xl"
                          key={key}
                        >
                          {children}
                        </h3>
